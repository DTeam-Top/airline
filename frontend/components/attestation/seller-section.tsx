...
import { DVP_CONTRACT_ADDRESS, ZERO_ADDRESS } from "@/lib/constants"
    ...
    useEffect(() => {
        async function getMetadata(tokenId: string) {
            ...
            const result = await axios.get(
                `https://resources.smarttokenlabs.com/${env.NEXT_PUBLIC_CHAIN_ID}/${token}/${tokenId}`,
                {
                    headers: {
                        "Content-Type": "application/json",
                    },
